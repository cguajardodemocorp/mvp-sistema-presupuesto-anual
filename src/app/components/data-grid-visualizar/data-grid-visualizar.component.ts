...
@Component({
  selector: 'app-data-grid-visualizar',
  standalone: true,
  ...
  styles: [`
    ...
    /* Animación suave para las filas */
    .fade-in {
...
export class DataGridVisualizarComponent {
  @Input() data: any[] = [];
  @Input() tipoGrid: 'plan-anual' | 'gasto-real' | 'otro' = 'gasto-real';
